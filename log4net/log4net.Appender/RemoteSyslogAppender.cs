...
namespace log4net.Appender
{
	...
	public class RemoteSyslogAppender : UdpAppender
	{
		...
		protected override void Append(LoggingEvent loggingEvent)
		{
			...
			{
				ErrorHandler.Error("Unable to send logging event to remote syslog " + base.RemoteAddress.ToString() + " on port " + base.RemotePort.ToString() + ".", e, ErrorCode.WriteFailure);
			}
		}
