...
namespace log4net.Core
{
	...
	public class LoggingEvent : ISerializable
	{
		...
		public DateTime TimeStamp
		{
			get
			{
				return m_data.TimeStampUtc.ToLocalTime();
			}
		}
        ...
        public string UserName
        {
            get
            {
                string userName = m_data.UserName;
                object obj = userName;
                if (obj == null)
                {
                    string reference = userName;
                    string obj2 = TryGetCurrentUserName() ?? SystemInfo.NotAvailableText;
                    string text = obj2;
                    reference = obj2;
                    obj = text;
                }
