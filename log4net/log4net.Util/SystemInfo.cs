...
namespace log4net.Util
{
	...
	public sealed class SystemInfo
	{
		...
		public static DateTime ProcessStartTime
		{
			get
			{
				return s_processStartTimeUtc.ToLocalTime();
			}
		}
		...
		static SystemInfo()
		{
			...
			s_processStartTimeUtc = DateTime.UtcNow;
			string text = "(null)";
			...
			{
				LogLog.Debug(declaringType, "Initializing NotAvailableText value to [" + appSetting2 + "].");
				text2 = appSetting2;
			}
